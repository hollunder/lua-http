describe("cookies module", function()
	...
	it("implements examples from spec", function()
		...
		assert(s:store("example.com", "/", true, true, http_cookies.parse_setcookie("SID=31d4d96e407aad42")))
		...
		assert(s:store("example.com", "/", true, true, http_cookies.parse_setcookie("SID=31d4d96e407aad42; Path=/; Domain=example.com")))
		assert.same("SID=31d4d96e407aad42", s:lookup("example.com", "/", true, true))
		assert.same("SID=31d4d96e407aad42", s:lookup("example.com", "/other", true, true))
		assert.same("SID=31d4d96e407aad42", s:lookup("subdomain.example.com", "/", true, true))
		assert.same("", s:lookup("other.com", "/", true, true))

		assert(s:store("example.com", "/", true, true, http_cookies.parse_setcookie("SID=31d4d96e407aad42; Path=/; Secure; HttpOnly")))
		assert(s:store("example.com", "/", true, true, http_cookies.parse_setcookie("lang=en-US; Path=/; Domain=example.com")))
		...
		assert(s:store("example.com", "/", true, true, http_cookies.parse_setcookie("lang=en-US; Expires=Wed, 09 Jun 2021 10:18:14 GMT")))
